package com.example.lasvegasviews;
...
public class SecondActivity extends AppCompatActivity {
    ...
    TextView second_tilte , second_subtitle, second_rating_number, second_rating_number2 , more_details;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        second_tilte = findViewById(R.id.second_title);
        ...
        second_tilte.setAnimation(from_right);
